import IntResponse from '../interfaces/int_response';
import productModel from '../models/mod_products';
import IntProduct from '../interfaces/int_products';
import logger from '../../lib/logger';
import IntProducts from '../interfaces/int_products';

export default class ProductsController {

    createProduct(product: IntProducts): Promise<IntResponse> {
    ...
    readProductByCategory(category: string): Promise<IntResponse> {
    ...
    readProductByName(name: string): Promise<IntResponse> {
